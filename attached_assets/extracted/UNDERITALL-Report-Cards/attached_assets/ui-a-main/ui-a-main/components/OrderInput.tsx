...
const OrderInput: React.FC<OrderInputProps> = ({ orderJson, setOrderJson, onGenerate, error }) => {
  return (
    <div className="flex-1 flex flex-col p-4">
      ...
      />
      {error && (
        <div className="mt-3 flex items-start gap-2 text-red-400 bg-red-900/50 p-3 rounded-md">
